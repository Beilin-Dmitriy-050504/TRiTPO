...
**Требования.** При наборе очков, во время удаления каждых 10 линий, задержка между таками падения блока должна уменьшаться. Всего должно быть предусмотрено 10 уровней такого ускорения.
